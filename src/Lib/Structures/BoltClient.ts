...
import TypeORMProvider from './SettingsProvider';
...
export default class BoltClient extends AkairoClient {
    ...
    public commandHandler = new CommandHandler(this, {
		...
		prefix: ['🎶', '🎵', '🎼', '🎹', '🎺', '🎻', '🎷', '🎸', '🎤', '🎧', '🥁', (this.config.prefix as string) ?? 'b!'].flat(),
		aliasReplacement: /-/g,
		allowMention: true,
		handleEdits: true,
		commandUtil: true,
    ...
    public listenerHandler = new ListenerHandler(this, { directory: join(__dirname, '..', '..', 'Events') });
